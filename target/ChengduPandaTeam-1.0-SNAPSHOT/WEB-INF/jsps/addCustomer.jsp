        ...
        <form action="<%=request.getContextPath()%>/customer/addCustomer" method="post">
            <table width="500px" height="300px">
                <tr>
                    ...
                    <td><input type="text" name="customerName" class="textinput"required="required"></td>
                </tr>
                <tr>
                    <td class="item_name">性别</td>
                    <td>
                        <input type="radio" name="customerSex" id="nan" value="男"> <label for="nan" class="item_name">男</label>
                        <input type="radio" name="customerSex" id="nv" value="女"> <label for="nv" class="item_name">女</label>
                    </td>
                </tr>
                <tr>
                    <td class="item_name">电话</td>
                    <td><input type="text" name="customerTel" class="textinput"
                ...
                <tr>
                    ...
                    <td><input type="text" name="customerAddress" class="textinput"required="required"></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
